...
for line in request.urlopen(target_url):
    ...
    print('')
    print(f"{Fore.LIGHTWHITE_EX}Cracked by kek.#1660 and protein#9023".center(width))
    print('')
    print(f"{Fore.BLUE}License Key: ".center(width))
    input()
    print(Fore.GREEN + "Cracked by kek.#1660 and protein#9023 xD".center(width))
    time.sleep(2)
    os.system("cls")
